...
plt.rcParams['font.family'].append('Source Han Sans SC')
...
parula = mpl.colors.LinearSegmentedColormap.from_list('parula', np.load(os.path.join(assets_dir, 'mplstyle/parula_map.npy')))
